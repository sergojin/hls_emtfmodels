...
if {[file isfile emtfptnn.autotvin.dat]} {
	file delete -force emtfptnn.autotvin.dat
}

if {[file isfile emtfptnn.autotvout.dat]} {
	file delete -force emtfptnn.autotvout.dat
}
