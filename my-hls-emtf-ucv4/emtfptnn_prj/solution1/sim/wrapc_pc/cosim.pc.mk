...
$(ObjDir)/emtfptnn_test.cpp_pre.cpp.tb.o : emtfptnn_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling emtfptnn_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/emtfptnn.cpp_pre.cpp.tb.o : emtfptnn.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling emtfptnn.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
